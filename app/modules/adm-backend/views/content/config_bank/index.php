    ...
    <div class="card">
      <div class="card-body">
          ...
          <div class="btn-group-header">
            ...
            <a href="<?=site_url("adm-backend/config_bank/add")?>" id="tambah" class="btn btn-success btn-sm btn-icon-text"><i class="fa fa-plus btn-icon-prepend"></i> Tambah</a>
          </div>
...
$(document).ready(function() {
    $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
    {
      ...
      var t = $("#table").dataTable({
          ...
          processing: true,
          serverSide: true,
          ajax: {"url": "<?=base_url()?>adm-backend/config_bank/json", "type": "POST"},
          columns: [
              {
                  "data": "id_rekening",
                  "orderable": false
...
$(document).on("click","#tambah",function(e){
  ...
  $('.modal-dialog').removeClass('modal-lg')
                    ...
                    .addClass('modal-md');
  $("#modalTitle").text('Tambah data rekening');
...
$(document).on("click","#edit",function(e){
  ...
  $('.modal-dialog').removeClass('modal-lg')
                    .removeClass('modal-sm')
                    .addClass('modal-md');
  $("#modalTitle").text('Edit data rekening');
  $('#modalContent').load($(this).attr('href'));
  $("#modalGue").modal('show');
});
